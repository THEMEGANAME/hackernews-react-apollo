...
const NEW_LINKS_SUBCRIPTION = gql`
  subscription {
    newLink{
      id
      url
...
export default class LinkList extends Component {
  ...
  _subscribeToNewLinks = subscribeToMore => {
    subscribeToMore({
      document: NEW_LINKS_SUBCRIPTION,
          ...
          ({ loading, error, data, subscribeToMore }) => {
            ...
            return (
              <Fragment>
                ...
                {
                  isNewPage && (
                    <div className="flex ml4 mv gray">
                      <div className="pointer mr2" onClick={this._previousPage}>Previous</div>
                      <div className="pointer mr2" onClick={this._nextPage(data)}>Next</div>
